...
Result_R1_p9 = Evaluation (im1_o,im2_o,imgf1,256);
...
Result_R2_p9 = Evaluation (im1_o,im2_o,imgf2,256);
clear sigma;
...
Result_R3_p9 = Evaluation (im1_o,im2_o,imgf3,256);
clear sigma;
...
Result_R4_p9 = Evaluation (im1_o,im2_o,imgf4,256);
clear sigma;
...
Result_R5_p9 = Evaluation (im1_o,im2_o,imgf5,256);
clear sigma;
