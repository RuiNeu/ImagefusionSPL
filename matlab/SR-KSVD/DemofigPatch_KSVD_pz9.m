...
%% setting parameters
load(['LearnedD81X256']); %patch size 9

sigma = 0;
im1=double(im1_o);
im2=double(im2_o);
[imgf1,~] = mainSRKSVD(im1,im2,Dksvd);
Result_K1_p9 = Evaluation (im1_o,im2_o,imgf1,256);
clear sigma;
...
Result_K2_p9 = Evaluation (im1_o,im2_o,imgf2,256);
clear sigma;
...
Result_K3_p9 = Evaluation (im1_o,im2_o,imgf3,256);
clear sigma;
...
Result_K4_p9 = Evaluation (im1_o,im2_o,imgf4,256);
clear sigma;
...
Result_K5_p9 = Evaluation (im1_o,im2_o,imgf5,256);
clear sigma;
