...
pz = 5;
load(['LearnedD25X256']);
[imgf1,Result_K1] = mainSRKSVD(im1,im2,Dksvd);
clear Dksvd;

pz = 6;
load(['LearnedD36X256']);
[imgf2,Result_K2] = mainSRKSVD(im1,im2,Dksvd);
clear Dksvd;

pz = 7;
load(['LearnedD49X256']);
[imgf3,Result_K3] = mainSRKSVD(im1,im2,Dksvd);
clear Dksvd;

pz = 8;
load(['LearnedD64X256']);
[imgf4,Result_K4] = mainSRKSVD(im1,im2,Dksvd);
clear Dksvd;

pz = 9;
load(['LearnedD81X256']);
[imgf5,Result_K5] = mainSRKSVD(im1,im2,Dksvd);
clear Dksvd;
