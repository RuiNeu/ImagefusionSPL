...
[imgf1,Result1_sigma] = mainFusionFunction(noise_gray_image_input1,noise_gray_image_input2,x_cols,Omega);
clear Omega;

x_cols = 6;
load(['LearnedOmega_adm64X36']) ;
[imgf2,Result2_sigma] = mainFusionFunction(noise_gray_image_input1,noise_gray_image_input2,x_cols,Omega);
clear Omega;

x_cols = 7;
load(['LearnedOmega_adm64X49']) ;
[imgf3,Result3_sigma] = mainFusionFunction(noise_gray_image_input1,noise_gray_image_input2,x_cols,Omega);
clear Omega;

x_cols = 8;
load(['LearnedOmega_adm64X64']) ;
[imgf4,Result4_sigma] = mainFusionFunction(noise_gray_image_input1,noise_gray_image_input2,x_cols,Omega);
clear Omega;

x_cols = 9;
load(['LearnedOmega_adm64X81']) ;
[imgf5,Result5_sigma] = mainFusionFunction(noise_gray_image_input1,noise_gray_image_input2,x_cols,Omega);
clear Omega;
