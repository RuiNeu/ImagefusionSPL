...
noise_gray_image_input1 = double(noise_gray_image_input1);
noise_gray_image_input2 = double(noise_gray_image_input2);
[imgf3,Result3_p9] = mainFusionFunction(noise_gray_image_input1,noise_gray_image_input2,x_cols,Omega);
clear sigma;
...
noise_gray_image_input1 = double(noise_gray_image_input1);
noise_gray_image_input2 = double(noise_gray_image_input2);
[imgf4,Result4_p9] = mainFusionFunction(noise_gray_image_input1,noise_gray_image_input2,x_cols,Omega);
...
noise_gray_image_input1 = double(noise_gray_image_input1);
noise_gray_image_input2 = double(noise_gray_image_input2);
[imgf5,Result5_p9] = mainFusionFunction(noise_gray_image_input1,noise_gray_image_input2,x_cols,Omega);
clear sigma;
